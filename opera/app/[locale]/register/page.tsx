      ...
      >
        <div className="bg-white/40 backdrop-blur-3xl py-10 px-6 sm:px-10 shadow-[0_20px_80px_rgba(99,102,241,0.1)] rounded-[2.5rem] border-[1.5px] border-white/80 relative overflow-hidden group">
          ...
          <div className="mb-8 text-center relative z-10">
            <h2 className="text-3xl font-semibold leading-tight tracking-tight text-slate-900 font-sans">
              {t("register")}
            </h2>
          </div>
          ...
          <div className="space-y-6 relative z-10">
            ...
            <AnimatePresence>
              ...
              {successMessage && (
                <motion.div 
                  ...
                  animate={{ opacity: 1, height: "auto" }}
                  exit={{ opacity: 0, height: 0 }}
                  className="text-xs font-medium text-emerald-600 border-l-2 border-emerald-500 pl-3 py-2 bg-emerald-50/50 backdrop-blur-sm rounded-r-md overflow-hidden"
                >
                  {successMessage}
                </motion.div>
              )}
            ...
            <div className="text-center text-xs font-medium text-slate-500 mt-6 pt-5 border-t border-slate-200/50">
              ...
              <Link
                href="/login"
                className="font-bold text-[#6366F1] hover:text-[#4F46E5] uppercase tracking-wider transition-colors ml-1"
              >
                {t("signIn")}
              </Link>
            </div>
