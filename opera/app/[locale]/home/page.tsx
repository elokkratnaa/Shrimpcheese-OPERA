...
import AnalysisClientVertical from "@/app/components/shared/AnalysisClientVertical";
...
const dict = {
  en: {
    ...
    keepSharing:
      "Keep sharing. The council will start reading your thought patterns after a few sessions.",
  },
  id: {
    ...
    keepSharing:
      "Teruslah bercerita. Council akan mulai membaca pola pemikiranmu setelah beberapa sesi.",
  },
};
              ...
              <div className="flex flex-col gap-5">
                {sessions.map((session) => (
                  <div
                    ...
                    className="bg-white/50 backdrop-blur-3xl border border-white/80 rounded-[2rem] p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_80px_rgba(99,102,241,0.08)] transition-all group relative overflow-hidden flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6"
                  >
