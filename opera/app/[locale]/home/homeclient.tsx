...
const dict = {
  en: {
    ...
    heroSub:
      "Describe a situation, dilemma, or decision you'd like to think through. Your council will help you explore it from different perspectives.",
  ...
  id: {
    ...
    heroSub:
      "Ceritakan situasi, dilema, atau keputusan yang sedang kamu hadapi. Dewan personalmu akan membantu melihatnya dari berbagai sudut pandang.",
