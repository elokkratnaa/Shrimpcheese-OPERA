...
const Icons = {
  Structure: () => <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>,
  Score: () => <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>,
  Memory: () => <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M12 7v5l4 2"/></svg>,
  Career: () => <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>,
  Relation: () => <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M20.42 4.58a5.4 5.4 0 0 0-7.65 0l-.77.78-.77-.78a5.4 5.4 0 0 0-7.65 0C1.46 6.7 1.33 10.28 4 13l8 8 8-8c2.67-2.72 2.54-6.3.42-8.42z"/></svg>,
  Relocation: () => <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>,
  Family: () => <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>,
  Growth: () => <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="m8 14 4-4 4 4"/></svg>,
  Finance: () => <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
};
    ...
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
      {fragments.map((frag, i) => (
        <motion.div
          ...
          transition={{ duration: 10 + i * 2, repeat: Infinity, ease: "easeInOut", delay: frag.delay }}
        ...
        >
          ...
          >
            <div className="flex items-center gap-3 mb-2.5">
              <div className="w-5 h-5 rounded-full bg-purple-50 flex items-center justify-center text-[10px] font-serif italic text-purple-600 border border-purple-100/50">L</div>
              <span className="text-[9px] font-bold tracking-[0.2em] text-slate-500 uppercase font-mono">Luna</span>
            </div>
            <p className="text-sm font-serif italic text-slate-700 leading-relaxed">"{current.luna}"</p>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3 mb-2.5">
              <div className="w-5 h-5 rounded-full bg-blue-50 flex items-center justify-center text-[10px] font-serif italic text-blue-600 border border-blue-100/50">S</div>
              <span className="text-[9px] font-bold tracking-[0.2em] text-slate-500 uppercase font-mono">Sage</span>
            </div>
            <p className="text-sm font-serif italic text-slate-700 leading-relaxed">"{current.sage}"</p>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3 mb-2.5">
              <div className="w-5 h-5 rounded-full bg-orange-50 flex items-center justify-center text-[10px] font-serif italic text-orange-600 border border-orange-100/50">B</div>
              <span className="text-[9px] font-bold tracking-[0.2em] text-slate-500 uppercase font-mono">Baz</span>
            </div>
            <p className="text-sm font-serif italic text-slate-700 leading-relaxed">"{current.baz}"</p>
          </motion.div>
...
export default function UnifiedLandingPage() {
  ...
  const content = {
    EN: {
      nav: { features: "Features", howItWorks: "How it works", personas: "Personas", useCases: "Use cases", signIn: "Sign In", getStarted: "Get started" },
      hero: {
        label: "OPERA • Personal Decision Council",
        headlineStart: "Every decision deserves more than one ",
        headlineHighlight: "perspective.",
        subheadline: "When you're stuck between choices, OPERA brings together three distinct minds to help you think clearly—not tell you what to do.",
      ...
      capabilities: {
        ...
        subheadline: "OPERA is a deliberate practice partner designed around the way human psychology actually works, far beyond simple pros and cons.",
        dominant: {
        ...
        items: [
          { title: "Structured Reflection", desc: "Turn an overwhelming web of thoughts into cleanly organized reasoning and actionable insights.", icon: <Icons.Structure /> },
          { title: "Decision Clarity Score", desc: "Measure quantitatively how your emotional state evolves throughout a session.", icon: <Icons.Score /> },
          { title: "Coaching Memory", desc: "Tracks your cognitive growth across sessions and surfaces behavioral patterns.", icon: <Icons.Memory /> }
        ]
      },
      howItWorks: {
        label: "ARCHITECTURE",
        ...
        subheadline: "OPERA guides you through an organic reflection process designed to uncover constraints you may have missed.",
        steps: [
          { num: "01", title: "Share what's on your mind", desc: "Describe the situation you're facing and the explicit decision parameters you're struggling to calculate." },
          { num: "02", title: "Meet your council", desc: "LUNA, SAGE, and BAZ analyze the prompt asynchronously through completely independent psychological prisms." },
          { num: "03", title: "Gain clarity", desc: "Receive a balanced overview structure, spot hidden friction points, and walk forward cleanly." }
        ]
      },
      useCases: {
        label: "APPLICATIONS",
        ...
        items: [
          { title: "Career Transitions", desc: "Should I shift roles or transition into venture independence?", icon: <Icons.Career /> },
          { title: "Relationships", desc: "Am I building on safety logic, or avoiding hard conversations?", icon: <Icons.Relation /> },
          { title: "Major Relocations", desc: "Is this the right time to move across the country for a new start?", icon: <Icons.Relocation /> },
          { title: "Family Dynamics", desc: "Navigating structural family expectations and emotional boundaries.", icon: <Icons.Family /> },
          { title: "Personal Growth", desc: "Breaking cyclical habits to find raw clarity on what truly matters.", icon: <Icons.Growth /> },
          { title: "Financial Strategy", desc: "Calibrating capital allocation against asymmetric risk and timeline.", icon: <Icons.Finance /> }
        ]
      },
      cta: {
        headline: "Your next decision deserves a better perspective.",
        subheadline: "Don't navigate structural parameters alone. Invoke your personal council before jumping.",
        button: "Start Thinking"
      }
    },
    ID: {
      nav: { features: "Fitur", howItWorks: "Cara Kerja", personas: "Persona", useCases: "Kasus Penggunaan", signIn: "Masuk", getStarted: "Mulai Sekarang" },
      hero: {
        label: "OPERA • Dewan Keputusan Personal",
        headlineStart: "Setiap keputusan layak mendapat berbagai ",
        headlineHighlight: "perspektif.",
        subheadline: "Saat Anda terjebak di antara pilihan, OPERA menyatukan tiga pemikiran berbeda untuk membantu Anda berpikir jernih—bukan mendikte apa yang harus dilakukan.",
      ...
      capabilities: {
        ...
        subheadline: "OPERA adalah partner berlatih yang dirancang menyesuaikan dengan cara kerja psikologi manusia, jauh melebihi daftar pro-kontra biasa.",
        dominant: {
        ...
        items: [
          { title: "Refleksi Terstruktur", desc: "Ubah jaring pikiran yang luar biasa rumit menjadi penalaran yang tertata rapi dan wawasan yang tajam.", icon: <Icons.Structure /> },
          { title: "Skor Kejelasan Keputusan", desc: "Ukur secara kuantitatif bagaimana kondisi emosionalmu berkembang sepanjang sesi refleksi.", icon: <Icons.Score /> },
          { title: "Memori Pelatihan", desc: "Melacak perkembangan kognitifmu dan memunculkan pola perilaku berulang yang terlewatkan.", icon: <Icons.Memory /> }
        ]
      },
      howItWorks: {
        label: "ARSITEKTUR",
        ...
        subheadline: "OPERA memandumu melalui proses refleksi organik yang dirancang untuk mengungkap perspektif yang tersembunyi.",
        steps: [
          { num: "01", title: "Bagikan isi pikiranmu", desc: "Deskripsikan situasi yang sedang kamu hadapi dan parameter keputusan yang membuatmu kesulitan." },
          { num: "02", title: "Temui dewan personalmu", desc: "LUNA, SAGE, dan BAZ menganalisis ceritamu secara asinkron melalui prisma psikologis yang independen." },
          { num: "03", title: "Dapatkan kejelasan", desc: "Terima gambaran struktur yang seimbang, temukan titik gesekan yang tersembunyi, dan melangkah maju." }
        ]
      },
      useCases: {
        label: "APLIKASI",
        ...
        items: [
          { title: "Transisi Karir", desc: "Haruskah aku pindah peran atau beralih menjadi pekerja independen?", icon: <Icons.Career /> },
          { title: "Hubungan", desc: "Apakah aku bertahan karena zona nyaman, atau menghindari percakapan sulit?", icon: <Icons.Relation /> },
          { title: "Relokasi Besar", desc: "Apakah ini waktu yang tepat untuk pindah ke luar kota demi awal yang baru?", icon: <Icons.Relocation /> },
          { title: "Dinamika Keluarga", desc: "Menavigasi ekspektasi struktural keluarga dan batasan-batasan emosional.", icon: <Icons.Family /> },
          { title: "Pertumbuhan Personal", desc: "Mematahkan kebiasaan siklis untuk menemukan kejelasan murni tentang diri sendiri.", icon: <Icons.Growth /> },
          { title: "Strategi Finansial", desc: "Mengkalibrasi alokasi modal terhadap risiko asimetris dan linimasa masa depan.", icon: <Icons.Finance /> }
        ]
      },
      cta: {
        headline: "Keputusanmu selanjutnya layak mendapat perspektif yang lebih baik.",
        subheadline: "Jangan menavigasi parameter struktural sendirian. Panggil dewan personalmu sebelum melompat.",
    ...
    <div className="bg-[#F8FAFC] text-slate-900 font-sans antialiased relative overflow-hidden selection:bg-[#E0E7FF] selection:text-[#3730A3] min-h-screen">
      ...
      <header className="fixed top-6 inset-x-0 z-50 flex justify-center px-6">
        <div className="bg-white/40 backdrop-blur-3xl rounded-full px-6 py-3.5 flex items-center justify-between w-full max-w-5xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] border border-white/60">
          <a href="#hero" onClick={(e) => { e.preventDefault(); document.getElementById('hero')?.scrollIntoView({ behavior: 'smooth' }); }} className="flex items-center gap-3 font-medium text-xs uppercase tracking-[0.2em] text-slate-900 cursor-pointer hover:opacity-80 transition-opacity">
            <OperaLogo />
          ...
          <nav className="hidden lg:flex items-center gap-8 text-[11px] font-medium text-slate-600">
            <a href="#features" className="hover:text-slate-900 transition-colors py-1">{t.nav.features}</a>
            <a href="#how-it-works" className="hover:text-slate-900 transition-colors py-1">{t.nav.howItWorks}</a>
            <a href="#use-cases" className="hover:text-slate-900 transition-colors py-1">{t.nav.useCases}</a>
          </nav>
          <div className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-widest">
            <div className="flex items-center gap-1 bg-white/40 backdrop-blur-md p-1 rounded-full border border-slate-200/50">
              <button onClick={() => setLang("EN")} className={`px-3 py-1.5 rounded-full transition-all ${lang === "EN" ? "bg-white text-slate-900 shadow-sm" : "text-slate-400 hover:text-slate-600"}`}>EN</button>
              <button onClick={() => setLang("ID")} className={`px-3 py-1.5 rounded-full transition-all ${lang === "ID" ? "bg-white text-slate-900 shadow-sm" : "text-slate-400 hover:text-slate-600"}`}>ID</button>
            </div>
            <Link href="/login" className="text-slate-600 hover:text-slate-900 transition-colors hidden sm:inline-block">{t.nav.signIn}</Link>
          </div>
        </div>
      </header>

      {/* HERO SECTION: THINKING ENVIRONMENT */}
      <section id="hero" className="relative max-w-5xl mx-auto px-6 pt-40 pb-24 z-10 flex items-center min-h-[95vh]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full relative z-10">
          ...
          >
            ...
            <div className="pt-4">
              <Link href="/login" className="inline-block bg-slate-900/95 backdrop-blur-md text-white hover:bg-slate-800 font-medium rounded-full px-8 py-4 text-xs uppercase tracking-widest transition-all shadow-[0_8px_20px_rgba(0,0,0,0.08)] hover:-translate-y-1 hover:shadow-[0_15px_30px_rgba(99,102,241,0.2)]">
                {t.hero.ctaPrimary}
              </Link>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <PremiumCard className="lg:col-span-3 p-8 md:p-12 flex flex-col md:flex-row gap-10 items-center">
              <div className="flex-1 space-y-4">
                <div className="w-8 h-8 rounded-full bg-indigo-50/80 flex items-center justify-center text-indigo-500 mb-6 border border-indigo-100/50">✧</div>
                <h3 className="text-2xl font-serif text-slate-900">{t.capabilities.dominant.title}</h3>
                <p className="text-base text-slate-600 font-light leading-relaxed max-w-md">{t.capabilities.dominant.desc}</p>
              </div>
              ...
              <div className="flex-1 w-full relative h-[260px] flex items-center justify-center bg-white/40 rounded-3xl border border-white/60 overflow-hidden group shadow-inner">
                ...
                <div className="space-y-4 w-full px-6 md:px-10 relative z-10">
                  <motion.div animate={{ y: [0, -2, 0] }} transition={{ duration: 4, repeat: Infinity }} className="bg-white/80 backdrop-blur-md p-4 rounded-2xl rounded-tl-sm shadow-sm border border-white max-w-[85%]">
                    <p className="text-xs font-serif italic text-slate-700">"I understand. What feels most risky?" <span className="text-[9px] font-mono uppercase text-slate-400 ml-2 block mt-1">LUNA</span></p>
                  </motion.div>
                  <motion.div animate={{ y: [0, -2, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 1 }} className="bg-white/80 backdrop-blur-md p-4 rounded-2xl rounded-tl-sm shadow-sm border border-white max-w-[85%] ml-auto">
                    <p className="text-xs font-serif italic text-slate-700">"Let's analyze the failure modes." <span className="text-[9px] font-mono uppercase text-slate-400 ml-2 block mt-1">SAGE</span></p>
                  </motion.div>
                  <motion.div animate={{ y: [0, -2, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 2 }} className="bg-white/80 backdrop-blur-md p-4 rounded-2xl rounded-tl-sm shadow-sm border border-white max-w-[85%] ml-6">
                    <p className="text-xs font-serif italic text-slate-700">"Challenge that initial assumption." <span className="text-[9px] font-mono uppercase text-slate-400 ml-2 block mt-1">BAZ</span></p>
                  </motion.div>
                </div>
              </div>
            </PremiumCard>
            ...
            {t.capabilities.items.map((item, i) => (
              <PremiumCard key={i} delay={0.2 * (i + 1)} className="p-8 flex flex-col justify-between min-h-[240px]">
                <div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            ...
            {t.howItWorks.steps.map((step, i) => (
              <PremiumCard key={i} delay={0.2 * i} className="p-8 z-10 group overflow-hidden">
                <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${stepGradients[i]} opacity-80 group-hover:h-1.5 transition-all duration-300`} />
                ...
                <div className="w-12 h-12 rounded-2xl bg-white/80 backdrop-blur-md border border-white flex items-center justify-center text-sm font-mono font-bold shadow-sm mb-6">
                  <span className={`bg-clip-text text-transparent bg-gradient-to-br ${stepGradients[i]}`}>
                    {step.num}
                  </span>
                </div>
                <h3 className="font-semibold text-slate-900 mb-3">{step.title}</h3>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {t.useCases.items.map((item, i) => (
              <PremiumCard key={i} delay={0.1 * i} className="p-8 min-h-[180px]">
                <div className="flex items-center gap-2 mb-4">
                  <div className="text-[#8B5CF6]">
                    {item.icon}
                  </div>
                  <h4 className="text-[10px] font-semibold text-slate-900 uppercase tracking-widest opacity-80">{item.title}</h4>
                </div>
      ...
      <section className="py-32 relative z-10">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <Link href="/login" className="inline-block bg-slate-900 text-white font-medium rounded-full px-10 py-5 text-xs uppercase tracking-widest transition-all duration-500 shadow-[0_10px_30px_rgba(0,0,0,0.1)] hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(99,102,241,0.25)] relative z-10">
              {t.cta.button}
            </Link>
          </motion.div>
        </div>
      ...
      <footer className="w-full max-w-5xl mx-auto px-6 py-10 border-t border-slate-300/50 flex flex-col md:flex-row items-center justify-between gap-6 relative z-10 pb-16">
        <a href="#hero" onClick={(e) => { e.preventDefault(); document.getElementById('hero')?.scrollIntoView({ behavior: 'smooth' }); }} className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity">
          <OperaLogo />
          <span className="text-xs font-semibold tracking-widest text-slate-900 uppercase">
            OPERA <span className="text-slate-400 font-normal ml-2">© 2026</span>
          </span>
        </a>
        <nav className="flex items-center gap-8 text-[11px] font-medium text-slate-500">
          ...
          <a href="#use-cases" className="hover:text-slate-900 transition-colors">{t.nav.useCases}</a>
          <Link href="/login" className="hover:text-slate-900 transition-colors text-slate-900 font-semibold">{t.nav.getStarted}</Link>
        </nav>
      </footer>
